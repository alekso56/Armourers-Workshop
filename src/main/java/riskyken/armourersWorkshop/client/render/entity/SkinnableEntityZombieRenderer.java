...
public class SkinnableEntityZombieRenderer implements ISkinnableEntityRenderer {
    ...
    private void renderEquipmentType(EntityLivingBase entity, RenderLivingBase renderer, ISkinType skinType, IEntityEquipment equipmentData) {
	...
	@Override
	public void render(EntityLivingBase entity, RenderLivingBase renderer, double x, double y, double z,
